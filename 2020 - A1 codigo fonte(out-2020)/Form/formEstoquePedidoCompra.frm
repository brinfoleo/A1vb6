...
Begin VB.Form formEstoquePedidoCompra 
   ...
   Begin TabDlg.SSTab sstDados 
      ...
      TabPicture(0)   =   "formEstoquePedidoCompra.frx":0000
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "Frame2"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "&2 - Transporte"
      TabPicture(1)   =   "formEstoquePedidoCompra.frx":001C
      ...
      Begin VB.Frame Frame12 
         ...
         Begin VB.Frame Frame16 
            ...
            Begin VB.TextBox txtObs 
               ...
               TabIndex        =   81
               Text            =   "formEstoquePedidoCompra.frx":0038
               Top             =   300
               Width           =   8475
            End
         End
      ...
      Begin VB.Frame Frame2 
         ...
         Begin VB.CommandButton btoMovAcima 
            Height          =   555
            Left            =   12660
            Picture         =   "formEstoquePedidoCompra.frx":003E
            Style           =   1  'Graphical
            TabIndex        =   25
         ...
         Begin VB.CommandButton btoMovAbaixo 
            Height          =   555
            Left            =   12660
            Picture         =   "formEstoquePedidoCompra.frx":0728
            Style           =   1  'Graphical
            TabIndex        =   24
         ...
         Begin VB.CommandButton btoNovoItem 
            Height          =   555
            Left            =   12660
            Picture         =   "formEstoquePedidoCompra.frx":0E12
            Style           =   1  'Graphical
            TabIndex        =   23
         ...
         Begin VB.CommandButton btpExcluirItem 
            Height          =   555
            Left            =   12660
            Picture         =   "formEstoquePedidoCompra.frx":14FC
            Style           =   1  'Graphical
            TabIndex        =   22
            Top             =   2220
            Width           =   375
         ...
         Begin MSFlexGridLib.MSFlexGrid msfgItens 
            ...
            SelectionMode   =   1
            AllowUserResizing=   1
            FormatString    =   $"formEstoquePedidoCompra.frx":1886
         End
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboUF 
         Height          =   315
         ItemData        =   "formEstoquePedidoCompra.frx":1A89
         Left            =   1260
         List            =   "formEstoquePedidoCompra.frx":1A8B
         Style           =   2  'Dropdown List
         TabIndex        =   4
         Top             =   1440
         Width           =   915
   ...
   Begin MSComctlLib.Toolbar tbMenu 
      ...
      BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty Button6 {66833FEA-8583-11D1-B16A-00C0F0283628} 
            Object.ToolTipText     =   "Clonar Pedido"
            ImageIndex      =   12
         EndProperty
      ...
      Begin MSComctlLib.ImageList ImageList1 
         ...
         BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
            ...
            BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":1A8D
               Key             =   ""
            EndProperty
            BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":1EDF
               Key             =   ""
            EndProperty
            BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":21F9
               Key             =   ""
            EndProperty
            BeginProperty ListImage4 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":2A8B
               Key             =   ""
            EndProperty
            BeginProperty ListImage5 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":3CDD
               Key             =   ""
            EndProperty
            BeginProperty ListImage6 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":45B7
               Key             =   ""
            EndProperty
            BeginProperty ListImage7 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":4E49
               Key             =   ""
            EndProperty
            BeginProperty ListImage8 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":56DB
               Key             =   ""
            EndProperty
            BeginProperty ListImage9 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":692D
               Key             =   ""
            EndProperty
            BeginProperty ListImage10 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":6C47
               Key             =   ""
            EndProperty
            BeginProperty ListImage11 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":6F61
               Key             =   ""
            EndProperty
            BeginProperty ListImage12 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":7358
               Key             =   ""
            EndProperty
            BeginProperty ListImage13 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":7A52
               Key             =   ""
            EndProperty
            BeginProperty ListImage14 {2C247F27-8591-11D1-B16A-00C0F0283628} 
               Picture         =   "formEstoquePedidoCompra.frx":814C
               Key             =   ""
            EndProperty
         EndProperty
      End
   End
End
Attribute VB_Name = "formEstoquePedidoCompra"
...
Public Function ClonarPV(pvOriginal As Integer, idPV As Integer, cItens As Integer, qtdItens As Variant) As Integer
    ...
    'formestoquepedidocompraItem.txtQuantidade.Text = "50"
    'formestoquepedidocompraItem.btoAdicionarItem_Click
...
Private Sub btocobrVisualizarParcelas_Click()
    ...
    MsgBox "formestoquepedidocompraPagamento.CarregarFormulario aCob, cCob"
End Sub
...
Private Sub CalcVlPV()
    ...
    For itens = 1 To msfgItens.Rows - 1
        If msfgItens.TextMatrix(itens, 20) = "S" Then
...
Private Sub MovItem(Optional nQtd As String)
    ...
    Retorno = formEstoquePedidoCompraItem.CarregarFormulario(Envio, cReg, nQtd)
    
    
    
    'ID|Referencia|Descricao|NCM|Unid|Qtd|vUnit|SubTotal|vIPI|vDesc|vTotal|pIPI|pICMS|N.Ped|item ped|Obs
    With msfgItens
        If IsArray(Retorno) Then
            ...
            .TextMatrix(lnPv, 14) = Retorno(19)
            .TextMatrix(lnPv, 15) = Retorno(14)
            .TextMatrix(lnPv, 16) = Retorno(15)
            .TextMatrix(lnPv, 17) = Retorno(16)
            .TextMatrix(lnPv, 18) = Retorno(17)
            .TextMatrix(lnPv, 19) = Retorno(18)
            .TextMatrix(lnPv, 20) = Retorno(20)
        End If
    End With
    CalcVlPV
    'txtItemID.SetFocus
...
Private Function grvRegistro() As Boolean
    ...
    For l = 1 To msfgItens.Rows - 1
        ...
        vReg(cReg) = Array("nPedido", Trim(msfgItens.TextMatrix(l, 16)), "S"): cReg = cReg + 1
        vReg(cReg) = Array("iPedido", Trim(msfgItens.TextMatrix(l, 17)), "S"): cReg = cReg + 1
        
        vReg(cReg) = Array("Obs", msfgItens.TextMatrix(l, 18), "S"): cReg = cReg + 1
        ...
        vReg(cReg) = Array("indTot", IIf(msfgItens.TextMatrix(l, 20) = "S", 1, 0), "N"): cReg = cReg + 1
                ...
                Else
                    ...
                    With msfgItens
                        ...
                        Do Until Rst.EOF
                            ...
                            .TextMatrix(.Rows - 1, 16) = IIf(IsNull(Rst.Fields("nPedido")), "", Rst.Fields("nPedido"))
                            .TextMatrix(.Rows - 1, 17) = IIf(IsNull(Rst.Fields("iPedido")), "", Rst.Fields("iPedido"))
                            .TextMatrix(.Rows - 1, 18) = IIf(IsNull(Rst.Fields("Obs")), "", Rst.Fields("Obs"))
                            .TextMatrix(.Rows - 1, 19) = IIf(IsNull(Rst.Fields("ComplDescricaoNFe")), "", Rst.Fields("ComplDescricaoNFe"))
                            
                            '.TextMatrix(.Rows - 1, 20) = IIf(IsNull(Rst.fields("destino")), "", Rst.fields("destino"))
                            
                            .TextMatrix(.Rows - 1, 20) = IIf(cNull(Rst.Fields("indTot")) = 0, "N", "S")
                            Rst.MoveNext
                        Loop
                        txtItens.Text = ZE(.Rows - 1, 5)
                    End With
...
Private Sub PesquisarCliente(Optional sCampo As String, Optional sBusca As String, Optional SN As String)
    ...
    If Trim(sCampo) = "" Then
        sBusca = formBuscar.IniciarBusca("Fornecedores", , , , , "Status='Ativo'") ', "xNome,xlgr,nro,xcpl,xbairro,xmun,uf,fone")
        sCampo = "Id"
        SN = "N"
        If Trim(sBusca) = 0 Then Exit Sub
    End If
    If LCase(sCampo) = "doc" Then sBusca = RS(sBusca)
    If SN = "N" Then
            sSQL = "SELECT * FROM fornecedores WHERE ID_Empresa = " & ID_Empresa & " AND Status='Ativo' AND " & sCampo & " = '" & sBusca & "'"
        Else
            sSQL = "SELECT * FROM fornecedores WHERE ID_Empresa = " & ID_Empresa & " AND Status='Ativo' AND " & sCampo & " = " & sBusca
    End If
        ...
        Else
            ...
            If Trim(cboTransportadora.Text) = "" Then
                If Not IsNull(Rst.Fields("Transportadora")) And Trim(Rst.Fields("Transportadora")) <> 0 Then
                    cboTransportadora.Clear
                    IdTransp = Left(Trim(Rst.Fields("Transportadora")), 6)
                    cboTransportadora.AddItem ZE(Trim(IdTransp), 6) _
                                            & " - " & pgDadosTransportadora(IdTransp).Nome
                    cboTransportadora.Text = cboTransportadora.List(0)
...
Private Sub cboCliente_DropDown()
    Dim Rst As Recordset
    idCliente = 0
    Set Rst = RegistroBuscar("SELECT * FROM fornecedores WHERE ID_Empresa = " & ID_Empresa & " AND xNome LIKE '" & cboCliente.Text & "%'")
    If Rst.BOF And Rst.EOF Then
            cboCliente.Clear
            Exit Sub
        Else
    ...
    If IdReg = 0 Then
        ...
        Else
            If MsgBox("Deseja relamente EXCLUIR este registro?                 " & vbCrLf & _
                        vbCrLf & _
                        "Pedido de Compra.: " & txtID.Text, vbYesNo + vbQuestion) = vbYes Then
...
Private Sub EnviarViaEmail()
    ...
    sSQL = "SELECT * FROM estoquepedidocompra WHERE ID=" & IdReg
    Set Rst = RegistroBuscar(sSQL)
    If Rst.BOF And Rst.EOF Then
    ...
    sSQL = "SELECT * FROM estoquepedidocompraItens WHERE IdPV=" & IdReg
...
Private Sub Cancelar()
    If MsgBox("Deseja realmente abandorar, Pedido de Compra?", vbYesNo + vbExclamation, "Cancelar") = vbNo Then
        Exit Sub
    End If
    HDMenu Me, True
    HDFormulario (False)
...
'        MsgBox "Pedido de Compra não poderá ser alterada, pois possui Nota Fiscal vinculada.", vbInformation, "Aviso"
...
Private Sub ClonarPedido()
    ...
    End If
    If IdReg = 0 Then
        MsgBox "Favor selecionar um pediodo.", vbInformation, "Aviso"
        Exit Sub
    End If
    If MsgBox("Deseja realmente Clonar o Pedido de Compra n. " & Left(String(6, "0"), 6 - Len(Trim(IdReg))) & IdReg & "?", vbInformation + vbYesNo, "Aviso") = vbYes Then
        IdReg = 0
        If dtpEmissao.Value <> Date Then
            If MsgBox("Deseja alterar a data de emissão do pedido para hoje(" & Date & ")?", vbInformation + vbYesNo, "Aviso") = vbYes Then
                dtpEmissao.Value = Date
            End If
        End If
        If grvRegistro = True Then
                MsgBox "Novo pedido de compra n. " & Left(String(6, "0"), 6 - Len(Trim(IdReg))) & IdReg & vbCrLf & "Pedido de Compra clonada com sucesso.", vbInformation, "Aviso"
                PesquisarRegistro (IdReg)
            Else
                MsgBox "Erro ao criar clone do Pedido de Compra.", vbInformation, "Aviso"
        End If
    End If
End Sub
   ...
   sSQL = "SELECT * FROM FinanceiroCondicoesPagamentoParcelas WHERE IdCondicoes = " & idCobr & " ORDER BY Parcela"
    ...
    If Rst.BOF And Rst.EOF Then
        ...
        Else
            ...
            cCob = 0
            Do Until Rst.EOF
                Data = Date + IIf(IsNull(Rst.Fields("DiasCorridos")), 0, Rst.Fields("DiasCorridos"))
...
Private Function ValidarPV() As Boolean
    ...
    If idCliente <> "0" And PgDadosFornecedor(idCliente).Doc <> txtDoc.Text Then
