VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} xyz123 
...
Private Sub DataReport_Initialize()
    ...
    Set xyz123.Sections("Section4").Controls.Item("imgLogo").Picture = LoadPicture(PgDadosEmpresa(ID_Empresa).Logotipo)
    xyz123.Sections("Section3").Controls.Item("LblRodape").Caption = "A1 - v." & sVersao & " [Rev." & cVersao & "]"
End Sub
