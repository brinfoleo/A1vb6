...
Public Function IniciarBusca(nomeTabela As String, _
                             ...
                             Optional CampoOrdenar As String) As Integer
                             
    If nomeTabela = "" Then Exit Function
    If Trim(sColunas) = "" Then
            Select Case nomeTabela
                Case "EstoqueProduto"
                    CamposBusca = "Id," & "Descricao, Referencia, CodigoBarras, NCM,IPIAliquota,ICMSCST,saldo,ID_Empresa,Deposito,InformacoesComplementares"
                Case "Clientes"
