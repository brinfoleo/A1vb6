...
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptPedidoCompra 
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "PEDIDO  DE  COMPRA"
         Alignment       =   2
      EndProperty
      ItemType2       =   6
   ...
   EndProperty
End
Attribute VB_Name = "rptPedidoCompra"
...
Private Sub DataReport_Initialize()
    ...
    Set rptPedidoCompra.Sections("Section4").Controls.Item("imgLogo").Picture = LoadPicture(PgDadosEmpresa(ID_Empresa).Logotipo)
    
    'MsgBox rptPedidoCompra.Sections("Section1").Controls.Item("txtVlUnitario").DataFormat ' = "#.##0," & String(cDecMoeda, "0")
