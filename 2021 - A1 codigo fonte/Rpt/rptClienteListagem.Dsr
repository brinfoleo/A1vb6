VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} rptClienteListagem 
   ...
   BeginProperty Section1 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item0 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Listagem de Clientes"
         Alignment       =   2
      EndProperty
      ItemType1       =   5
   ...
   EndProperty
End
Attribute VB_Name = "rptClienteListagem"
...
Private Sub DataReport_Initialize()
    ...
    Set rptClienteListagem.Sections("Section4").Controls.Item("imgLogo").Picture = LoadPicture(PgDadosEmpresa(ID_Empresa).Logotipo)
    rptClienteListagem.Sections("Section3").Controls.Item("LblRodape").Caption = "A1 - v." & sVersao & " [Rev." & cVersao & "]"
End Sub
