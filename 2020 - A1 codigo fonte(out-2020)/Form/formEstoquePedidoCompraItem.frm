...
Begin VB.Form formEstoquePedidoCompraItem 
   ...
   Begin VB.Frame Frame3 
      ...
      Begin VB.TextBox txtCSTDescricao 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   50
         Text            =   "formEstoquePedidoCompraItem.frx":0000
         Top             =   1020
         Width           =   3975
      End
      Begin VB.TextBox txtNCMDescricao 
         ...
         MultiLine       =   -1  'True
         TabIndex        =   49
         Text            =   "formEstoquePedidoCompraItem.frx":0006
         Top             =   300
         Width           =   3975
      End
   ...
   Begin VB.CommandButton btoAdicionarItem 
      ...
      Height          =   735
      Left            =   10560
      Picture         =   "formEstoquePedidoCompraItem.frx":000C
      Style           =   1  'Graphical
      TabIndex        =   7
      Top             =   120
      Width           =   1695
   ...
   Begin VB.CommandButton btoCancelar 
      ...
      Height          =   735
      Left            =   10560
      Picture         =   "formEstoquePedidoCompraItem.frx":0316
      Style           =   1  'Graphical
      TabIndex        =   8
      Top             =   900
      Width           =   1695
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.TextBox txtUltPreco 
         ...
         TabIndex        =   53
         Text            =   "formEstoquePedidoCompraItem.frx":0620
         Top             =   180
         Width           =   6495
      End
   ...
   Begin TabDlg.SSTab SSTab 
      ...
      TabPicture(0)   =   "formEstoquePedidoCompraItem.frx":0626
      Tab(0).ControlEnabled=   0   'False
      Tab(0).Control(0)=   "Frame5"
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "NFe"
      TabPicture(1)   =   "formEstoquePedidoCompraItem.frx":0642
      Tab(1).ControlEnabled=   -1  'True
      Tab(1).Control(0)=   "Frame6"
      Tab(1).Control(0).Enabled=   0   'False
      Tab(1).ControlCount=   1
      TabCaption(2)   =   "Ordem de Compra"
      TabPicture(2)   =   "formEstoquePedidoCompraItem.frx":065E
      ...
      Begin VB.Frame Frame6 
         ...
         Begin VB.TextBox txtComplDescricaoNFe 
            ...
            ScrollBars      =   2  'Vertical
            TabIndex        =   29
            Text            =   "formEstoquePedidoCompraItem.frx":067A
            Top             =   240
            Width           =   5475
         End
      End
      Begin VB.Frame Frame5 
         ...
         Begin VB.TextBox txtComplDescricaoPV 
            ...
            ScrollBars      =   2  'Vertical
            TabIndex        =   27
            Text            =   "formEstoquePedidoCompraItem.frx":0680
            Top             =   240
            Width           =   5475
         End
      End
   End
End
Attribute VB_Name = "formEstoquePedidoCompraItem"
...
Public Function CarregarFormulario(vRec As Variant, cReg As Integer, nQtd As String) As Variant
    ...
    If pgDadosLinhaZero(CStr(vRec(0))) <> 0 Then
            ...
            txtnPedido.Text = vRec(17)
        
            txtiPedido.Text = vRec(18)
            txtComplDescricaoPV.Text = vRec(19)
            txtComplDescricaoNFe.Text = vRec(20)
            'chkIndustrializacao.Value = IIf(vRec(21) = "I", 1, 0)
            chkIndTot.Value = IIf(vRec(21) = "S", 0, 1)
            PgUltimoVenda
        Else
...
Private Sub btoAdicionarItem_Click()
    ...
    'ID|Referencia|Descricao|NCM|Unid|Qtd|vUnit|SubTotal|vIPI|vDesc|vTotal|pIPI|pICMS|N.Ped|item ped|ComplDescricaoPV|ComplDescricaoNFe
    ...
    Retorno = Array(txtItemID.Text, _
                    ...
                    IIf(chkIndustrializacao.Value = 1, "I", "C"))
    Unload Me
End Sub
...
Private Sub txtCST_Change()
    If Trim(txtCST.Text) = "" Then
        ...
        Exit Sub
    End If
    txtCSTDescricao.Text = UCase(PgDadosCST(txtCST.Text, "ICMS").Descricao)
